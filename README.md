...
Asigname como reviewer.
Yo reviso, damos feedback, y hacemos merge juntos.
...
Todo PR pasa por revisión mía antes de hacer merge.
Cero secretos en el repo. API keys, contraseñas, tokens — todo va en .env (incluido en .gitignore).
Commits claros. Usa los prefijos listados arriba.
Si estás atascado más de 45 minutos, pregunta. Perder una tarde entera peleando solo no sirve a nadie.
